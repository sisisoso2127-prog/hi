...
machine's noise floor and no number of repeats changes that.
...
\noindent
Of the ten, four are wins, four are losses, one is a tie and one pays in
...
exact rational arithmetic throughout, and carries 60 tests. Several check
