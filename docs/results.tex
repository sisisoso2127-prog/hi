...
\begin{table}[h]
\centering
\caption{The twelve things tried, with what each was worth.}
\begin{tabular}{lll}
\toprule
...
\noindent
Five are losses and one is a tie.  They are reported at the same length as the
...
third-party dependency, and 64 tests run on every commit.  Several check
