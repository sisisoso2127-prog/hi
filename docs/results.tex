...
\begin{table}[h]
\centering
\caption{The nineteen things tried, with what each was worth.}
\begin{tabular}{lll}
\toprule
...
\noindent
Eight are losses and one is a tie.  They are reported at the same length as the
...
third-party dependency, and 92 tests run on every commit.  Several check
