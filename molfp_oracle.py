...
# ----------------------------------------------------------------------------
# Compatibilite : `solve_P` a demenage dans molfp_exact.py (voir son en-tete).
# L'acces paresseux evite l'import circulaire, molfp_exact important ce
# module. Les appelants historiques continuent de fonctionner sans changement.
# ----------------------------------------------------------------------------

def __getattr__(name):
    if name in ("solve_P", "HybridResult"):
        import molfp_exact
        return getattr(molfp_exact, name)
