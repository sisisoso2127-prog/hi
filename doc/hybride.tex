...
pourcentage. Remesuré dans les \emph{deux} configurations.\
\conf{0}{0}{0} \emph{et} \conf{1}{1}{1}}
\label{tab:cglp}
\setlength{\tabcolsep}{4pt}
\begin{tabular}{cc cccc cccc}
\toprule
& & \multicolumn{4}{c}{\conf{0}{0}{0}} & \multicolumn{4}{c}{\conf{1}{1}{1}}\\
...
$40$ & $0{,}5$& $0{,}0$  & $0{,}0$  & $+0{,}00$ & $9$
              & $0{,}0$  & $0{,}0$  & $+0{,}00$ & $11$\\
\midrule
\multicolumn{10}{l}{reproductibilité $6/6$ dans les deux configurations
...
\multicolumn{10}{l}{\conf{1}{1}{1} : améliorées $\mathbf{0}$, dégradées
 $\mathbf{0}$, inchangées $\mathbf{6}$ ; maximum
 $\mathbf{+0{,}00}$}\\
\bottomrule
\end{tabular}
\end{table}
...
\emph{durcit}.} Ce banc a d'abord été mené en \conf{0}{0}{0}, dont les
écarts de référence allaient de $79$ à $99\ \%$. On pouvait objecter qu'un
levier ne se juge pas sur un socle aussi lâche : $0{,}11$ point s'y perd
dans le bruit. La configuration courante retire cette objection. Les écarts
de référence y sont $77{,}2$, $78{,}6$, $\mathbf{1{,}2}$ et $96{,}5\ \%$, et
le gain de la coupe générée vaut alors $\mathbf{+0{,}00}$ point sur les
\emph{six} lignes -- pas une améliorée, pas une dégradée. Les coupes
continuent pourtant d'être produites, et en plus grand nombre qu'avant
($20$, $16$, $11$, $11$, $6$) : le mécanisme n'est pas en défaut, son effet
est nul.

Le cas décisif est la ligne $n=30$, $\text{corr}=0{,}5$. Son écart de
référence est passé de $78{,}9$ à $\mathbf{1{,}2\ \%}$ : la borne y est à un
point de fermer. Six coupes générées ne la ferment pas. Tant que l'écart
valait $79\ \%$, on pouvait croire que la coupe agissait sans qu'on le voie ;
à $1{,}2\ \%$, cet argument tombe.
