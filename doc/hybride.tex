...
variables d'un coup. Mais il ne mérite pas le rang que la description lui
donnait.
...
\paragraph{Le mouvement C.} Quatre améliorations pour $316$ appels entiers
(tableau~\ref{tab:voisinage}). Soit sa conception est à revoir, soit sa
place dans le menu ; en l'état il consomme près d'un cinquième du budget de
recherche pour un rendement trois fois moindre que le mouvement A.
