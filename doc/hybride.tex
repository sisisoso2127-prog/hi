...
n'ait été évaluée. Sur $90$ instances à budget identique, l'optimalité
prouvée passe de $84$ à $86$, le nombre médian d'appels au solveur entier de
$124$ à $97$ et le temps médian de $0{,}9$~s à $0{,}7$~s ; sur le régime
cible, de $57/80$ à $75/80$ preuves. Deux illustrations numériques
entièrement détaillées, à $2$ puis $3$ variables, exposent le mécanisme pas
à pas.
\end{abstract}
...
médian passer de $20{,}2\ \%$ à $0{,}6\ \%$ et de $6{,}8\ \%$ à $0{,}0\ \%$.
La première est celle qu'il faut $433$~s et $177$ coupes pour prouver par
l'oracle exact seul.
...
\noindent
L'apport est strictement positif sur \emph{tous} les axes à la fois : deux
preuves de plus, même qualité de solution, et un coût \emph{moindre} --
$97$ appels médians contre $124$, pour $0{,}7$~s contre $0{,}9$. La coupe
d'efficacité ne s'ajoute pas au travail : elle le remplace avantageusement,
puisqu'une preuve obtenue tôt épargne les tours suivants.
...
borne à grande taille, c'est le \emph{plafond} lui-même -- donc le coût de
$p$ binaires par coupe. Désagréger la disjonction~\eqref{eq:disj} devient la
priorité, et l'on sait désormais qu'il y a, derrière ce plafond, de la
matière à couper qui attend.
...
Deux directions restent ouvertes. La première est le plafond de coupes, que
la section~\ref{sec:res} désigne comme le verrou suivant : désagréger la
disjonction pour ramener le coût sous $p$ binaires par coupe. La seconde est
la clôture elle-même : nos mesures n'ont jamais rencontré deux points
efficaces de même vecteur critères, ce qui suggère qu'une condition
structurelle -- vérifiable une fois pour toutes sur l'instance plutôt qu'une
fois par point d'archive -- pourrait rendre la coupe entièrement gratuite.
