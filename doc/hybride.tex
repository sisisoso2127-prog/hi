...
Ce que la mesure suggère à sa place : à ces tailles, la région que l'on sait
retrancher -- celle qui entoure les points déjà connus, dominés ou
archivés -- ne représente qu'une part négligeable de ce qui sépare $\Rcal$
de $\Ecal$. Le problème n'est pas le nombre de coupes que l'on peut poser,
ni leur coût, mais le fait qu'aucune ne porte là où il le faudrait. Refermer
cet écart demanderait un relâché construit autrement, et non davantage de
coupes du même genre. Nous ne savons pas le construire, et nous préférons
l'écrire ainsi plutôt que de laisser la section précédente désigner un
verrou que la mesure a écarté.
