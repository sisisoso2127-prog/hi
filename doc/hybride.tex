...
établir pour un point efficace. Cela a une conséquence pratique que nous
n'avons pas exploitée : \textbf{un point de $\Scal$ dont le statut n'a pas
été déterminé peut servir de centre de coupe}. La précondition n'est plus
« être certifié dominé ou certifié efficace », mais seulement « être
réalisable, et voir sa clôture établie ». Or notre recherche \emph{jette}
aujourd'hui les points dont la chaîne de réparation a été interrompue faute
de budget : ils ne sont ni archivés ni retenus comme incumbents
(§\ref{sec:recherche}). Le théorème~\ref{th:effcut} dit qu'ils restent des
centres de coupe légitimes. Nous ne l'avons pas mesuré, et nous ne
prétendons donc pas que cela rapporte -- seulement que le théorème
l'autorise, et que la version restreinte l'interdisait à tort.
\end{remark}
