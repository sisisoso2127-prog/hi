...
défaut. « arch. » compte les coupes d'archive effectivement posées.}
...
comparaison appariée, chaque configuration jouée deux fois. Mesuré avec le
vivier \emph{alterné} (§\ref{sec:vivier}).}
\label{tab:geom}
\setlength{\tabcolsep}{4pt}
