...
Reste le cas où l'hétérogénéité compte réellement : la
section~\ref{sec:cglp} raisonne sur un écart de $98{,}6\ \%$ là où la
configuration courante en donne $77{,}2$ sur la même instance. Cela ne
change pas sa conclusion -- \emph{lever le plafond ne suffit pas} -- mais en
change les chiffres, et cette remesure-là reste à faire.
\end{remark}
...
entiers, comparaison appariée, chaque configuration jouée deux fois.\ \conf{0}{0}{0}}
\label{tab:cglp}
\setlength{\tabcolsep}{5pt}
