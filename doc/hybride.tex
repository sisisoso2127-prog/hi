...
identique. Écarts garantis.\ \conf{1}{1}{1}}
\label{tab:mouvementc}
\begin{tabular}{lccc}
\toprule
& médiane & moyenne & contre \emph{libre}\\
\midrule
\textbf{libre} (tel quel) & $0{,}6\ \%$ & $\mathbf{19{,}8\ \%}$ & --\\
ancré ($e_j\ge0$) & $\mathbf{0{,}0\ \%}$ & $22{,}9\ \%$
 & mieux $3$, pire $3$, égal $6$\\
retiré & $\mathbf{0{,}0\ \%}$ & $21{,}5\ \%$
 & mieux $3$, pire $3$, égal $6$\\
\bottomrule
\end{tabular}
\end{table}
...
\noindent
\textbf{Le banc ne tranche pas, et c'est le résultat.} Les deux traitements
donnent $3$ améliorées contre $3$ dégradées ; la médiane les favorise, la
moyenne favorise la version libre. Sur $12$ lignes et deux graines, rien ne
départage. Nous gardons donc la version libre -- changer un défaut demande
une preuve, pas une égalité -- et nous ne prétendons pas avoir conclu.

Deux choses sont acquises malgré tout. La première est que notre diagnostic
était faux : l'ancrage est le \emph{plus mauvais} des trois en moyenne, et
il effondre l'incumbent sur deux lignes ($4{,}39\to 2{,}27$ et
