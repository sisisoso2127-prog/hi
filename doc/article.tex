...
Zerdani et Moulaï ni Drici et collaborateurs ne couvrent.}
\label{tab:position}
\begin{tabular}{lll}
\toprule
...
$7+5$~s, vérité terrain disponible.}
\label{tab:archcut}
\begin{tabular}{lcc}
\toprule
...
\emph{dominé} : la relaxation $\Ecal\to\Scal$ pointe hors de $\Ecal$.}
\label{tab:ex2S}
\small
\begin{tabular}{ccccc}
\toprule
...
\begin{table}[htbp]
\centering
\caption{L'ensemble efficace de l'exemple à trois variables.}
\label{tab:ex3E}
\small
...
\begin{table}[htbp]
\centering
\caption{Confrontation à~\cite[section~5]{zerdani2011}.}
\label{tab:externe}
\begin{tabular}{lll}
\toprule
& publié & calculé ici\\
...
\centering
\caption{Lot figé, 90 instances, budget identique de 12~s. Toutes les
vérifications $C_1$--$C_4$ passent pour les trois méthodes.}
\label{tab:hybride}
\setlength{\tabcolsep}{5pt}
\begin{tabular}{lccccc}
\toprule
...
appliquée à tous de la même manière. Le préalable technique est un simplexe
donnant accès au tableau, ainsi qu'un simplexe fractionnaire ; le préalable
méthodologique est de restreindre la comparaison avec~\cite{drici2018} aux
instances à critères linéaires, seule intersection des deux classes de
problèmes.
