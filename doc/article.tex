...
\begin{enumerate}[leftmargin=*,itemsep=3pt]
\item \textbf{Aucun témoin complet issu de la littérature.} La
      proposition~\ref{prop:ecker} valide notre test d'efficacité contre
      celui d'Ecker et Kouada, mais un \emph{composant} validé n'est pas une
      méthode comparée : les algorithmes de~\cite{zerdani2011}
